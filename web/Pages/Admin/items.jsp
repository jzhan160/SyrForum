<%--
////////////////////////////////////////////////////////////////////
// items.jsp   show all the items for admin                       //
// ver 1.0                                                        //
						...
						<c:forEach items = "${itemsInfo}" var = "itemInfo">
							...
							<div class="contentList">
								<div class="panel panel-default">
									<div class="panel-body">
										<h4><a class="title" href="/DispatcherServlet?method=item&itemId=${itemInfo.getItem().getId()}&userName=admin&category=${itemInfo.getItem().getCatID()}&author=${itemInfo.getUserName()}&commentCount=${itemInfo.getCommentCount()}">${itemInfo.getItem().getItemName()}</a></h4>
										<p>
											<span class="overView">Author: &nbsp </span><span class="overView">${itemInfo.getUserName()}</span>

											<span><a href="/DispatcherServlet?method=deleteItem&itemId=${itemInfo.getItem().getId()}&userName=admin" type="button">&nbsp Delete</a></span>
											</span>
										</p>
									</div>
								</div>
