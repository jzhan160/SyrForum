<%--
////////////////////////////////////////////////////////////////////
// cars.jsp   main page for car category                          //
// ver 1.0                                                        //
// Author: Group Work                                             //
////////////////////////////////////////////////////////////////////
--%>
...
<html>
	...
	<head>
		<meta charset="UTF-8">
		<title>Forum Category Used Cars</title>
	</head>
							...
							<div id="w_carousel" class="carousel slide w_carousel" data-ride="carousel">
								...
								<div class="carousel-inner" role="listbox">
									<div class="item active">
										<img src="Pages/Views/img/slider/usedcars1.jpg" alt="...">
										<div class="carousel-caption">
											<h1>Used Cars</h1>
											<h3>Explore Desired Cars in a Cheaper Price!</h3>
										</div>
									</div>
									<div class="item">
										<img src="Pages/Views/img/slider/used cars 2.jpg" alt="...">
										<div class="carousel-caption">
										    <h1>Used Cars</h1>
											<h3>Sell Your Old Cars in a Desired Price!</h3>
										</div>	
									</div>
								</div>
